        ...
        stage('Deploy to Kubernetes with Ansible') {
            steps {
                ...
                sh '''
                    ...
                    #ansible-playbook -i inventory.ini ansible-playbook.yml
                    sudo -u akash env KUBECONFIG=/home/akash/.kube/config ansible-playbook -i /home/akash/mlops_project/inventory.ini /home/akash/mlops_project/ansible-playbook.yml --become
                '''
            }
        }
